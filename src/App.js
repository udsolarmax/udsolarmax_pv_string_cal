...
const DB_INVERTERS_RAW = [
  ...
  { id: 'solis_hyb_15k', brand: 'Solis', model: 'S6-EH3P15K02-NV-YD-L (3P Hybrid)', maxDcV: 1000, startV: 160, mpptCount: 2, maxStrings: 4, ratedAcKw: 15.0, maxDcKw: 30.0, maxIsc: 20, phase: 3 },  
  { id: 'solis_hyb_18k', brand: 'Solis', model: 'S6-EH3P18K02-NV-YD-L (3P Hybrid)', maxDcV: 1000, startV: 160, mpptCount: 2, maxStrings: 3, ratedAcKw: 18.0, maxDcKw: 36.0, maxIsc: 21, phase: 3 },  
...
const DB_PANELS = [
  ...
  { id: 'longi_645', brand: 'Longi', model: 'LR8-66HVD-645M 645W', pmax: 645, voc: 49.62, vmp: 40.88, isc: 16.46, tempCoeff: -0.27 }, 
  ...
  { id: 'trina_645', brand: 'Trina', model: 'Vertex TSM-NEGG20C.20 645W', pmax: 645, voc: 44.80, vmp: 37.20, isc: 18.33, tempCoeff: -0.30 },
  ...
  { id: 'ja_ุ630', brand: 'JA Solar', model: 'JAM66D45-630/LB 630W', pmax: 630, voc: 48.90, vmp: 40.70, isc: 16.18, tempCoeff: -0.27 },
